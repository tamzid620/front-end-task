            ...
            <div className="grid grid-cols-12 gap-4 ">
              ...
              <div className="col-span-12 md:col-span-7 mt-10 leading-11">
                <h1 style={{ fontFamily: fonts.rubik }}>
                  <span className="text-[#D6FB00] text-xl font-bold uppercase me-2">Name:</span>
                  <span className=" text-xl">{equipment?.title}</span>
                </h1>
                <p>
                  <span className="text-[#D6FB00] text-xl font-bold uppercase me-2">Price:</span>
                  <span className=" text-xl">{equipment?.price}</span>
                </p>
                <p>
                  <span className="text-[#D6FB00] text-xl font-bold uppercase me-2">Description:</span>
                  <span className=" text-xl">{equipment?.description}</span>
                </p>
                <p>
                  <span className="text-[#D6FB00] text-xl font-bold uppercase me-2">Rating:</span>
